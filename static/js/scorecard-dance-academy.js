...
const questions = [
    ...
    },
    {
        ...
        options: [
            ...
            { text: "No, we don't have a website", scores: { digital: 0 } }
        ]
    },
    {
        id: 3,
    ...
    },
    {
        ...
        options: [
            ...
            { text: "5-10 new students per month", scores: { acquisition: 1 } },
    ...
    },
    {
        ...
        options: [
            { text: "Over 50% come from referrals", scores: { acquisition: 2 } },
            { text: "25-50% come from referrals", scores: { acquisition: 1 } },
            { text: "Less than 25% / we don't track this", scores: { acquisition: 0 } }
        ]
    },
    {
        id: 10,
    ...
    },
    {
        ...
        options: [
            { text: "₹3-4 lakhs", scores: { readiness: 2 } },
            { text: "₹2-3 lakhs", scores: { readiness: 1 } },
...
function showEmailCapture() {
    ...
    const totalScore = scores.digital + scores.brand + scores.acquisition + scores.readiness;
    document.getElementById('score-total').value = totalScore;

    // Set result content fields
